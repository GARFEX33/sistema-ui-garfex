...
**Complete through PR 14E.** **Next dependency diagram:** `… → PR 13D5c → PR 13D5d → PR 14A → PR 14B → PR 14C → PR 14D1 → PR 14D2a → PR 14D2b → PR 14D3 → PR 14E → 📍 PR 15` / PR 14E. Each child remains below 399 A+D and retains the published `CREATED | CATALOG_CHANGED | INCOMPLETE | INVALID` union.
...
- [x] **PR 14E:** Stale, unknown, and transport-rejection integration proof plus focused review/create closure. <!-- sdd-owner: implementation -->
