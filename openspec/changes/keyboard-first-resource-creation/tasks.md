...
| Field | Value |
|-------|-------|
| Estimated changed lines | 950–1,360 A+D remaining after PR 14B; 43 implementation child slices total (4 remaining: PR 14C, PR 14D, PR 14E, PR 15) plus planning-doc slicing. |
